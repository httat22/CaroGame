    ...
    while not done:
        ...
        if playFirst != None:
            ...
            react = pygame.draw.rect(screen, GRAY, [(MARGIN + WIDTH) * int(
                12 / 2 - 2) + 10*MARGIN, (MARGIN + HEIGHT) * 12 + 5*MARGIN, WIDTH * 3, HEIGHT])
            ...
            text = font.render("Do you want to play first?", True, BLACK)
            screen.blit(text, react)
